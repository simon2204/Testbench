...
${OBJECTDIR}/src/ulam.o: src/ulam.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ulam.o src/ulam.c
...
${TESTDIR}/tests/ppr_tb_test_ulam.o: tests/ppr_tb_test_ulam.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ppr_tb_test_ulam.o tests/ppr_tb_test_ulam.c
...
${OBJECTDIR}/src/ulam_nomain.o: ${OBJECTDIR}/src/ulam.o src/ulam.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ulam_nomain.o src/ulam.c;\
	else  \
