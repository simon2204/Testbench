...
${OBJECTDIR}/src/justify_line.o: src/justify_line.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/justify_line.o src/justify_line.c

${OBJECTDIR}/src/main.o: src/main.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c
...
${TESTDIR}/tests/ppr_tb_extern_prototypes.o: tests/ppr_tb_extern_prototypes.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ppr_tb_extern_prototypes.o tests/ppr_tb_extern_prototypes.c


${TESTDIR}/tests/ppr_tb_test_justify_line.o: tests/ppr_tb_test_justify_line.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ppr_tb_test_justify_line.o tests/ppr_tb_test_justify_line.c
...
${OBJECTDIR}/src/justify_line_nomain.o: ${OBJECTDIR}/src/justify_line.o src/justify_line.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/justify_line_nomain.o src/justify_line.c;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.c;\
	else  \
