...
test1 :
	...
	-@cd $(BUILD_DIR) \
        && (./$(USER_SUBMISSION).o -c -o out.txt.hc -l7 -v in.txt; \
            ./$(TEST).o -retval 0 $$?; ) &
...
test4 :
	...
	-@cd $(BUILD_DIR) \
        && (./$(USER_SUBMISSION).o -d -o out.txt.hc in.txt; \
            ./$(TEST).o -retval 0 $$?; ) &
...
test7 :
	@echo
	@echo ================================================================;
	@echo Testfall 7 : Ungueltiger Level, muss zwischen 1 und 7 sein
...
test11 :
	...
	@echo    - Aufruf         : huffman -c -v -o LordOfTheRings.hc LordOfTheRings.txt  
	@echo    - Soll-Verhalten : Laufzeitmessung, byteweises Lesen bitweises Schreiben
	@echo
    
	-@cd $(BUILD_DIR) \
        && (./$(USER_SUBMISSION).o -c -v -o LordOfTheRings.hc LordOfTheRings.txt; \
            ./$(TEST).o -retval 0 $$?; ) &
...
test12 :
	...
	@echo    - Aufruf         : huffman -d -v -o LordOfTheRings.hd LordOfTheRings.hc.txt
	@echo    - Soll-Verhalten : Laufzeitmessung, bitweises Lesen bytewises Schreiben
	@echo
    
	-@cd $(BUILD_DIR) \
        && (./$(USER_SUBMISSION).o -d -v -o LordOfTheRings.hd LordOfTheRings.hc.txt; \
            ./$(TEST).o -retval 0 $$?; ) &
	...
	-@./$(BUILD_DIR)/$(CTRL).o -builddir $(BUILD_DIR) \
                             ...
                             -timeout $(TIMEOUT) \
	&& echo \
	&& ./$(TEST).o LordOfTheRings.hdcheck \
	             LordOfTheRings.hd

end :
    # Endbewertung durchfuehren (OK-Anzahl in %) 
	-@cd $(BUILD_DIR) \
	&& ./$(TEST).o -summary 12 $(STATS_DIR)/$(LEISTUNGEN)_$(TEST_DIR).csv
